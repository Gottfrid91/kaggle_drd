...
parser.add_argument('--save_dir', type=str, default='./config_2/',
...
def train():
    ...
    with tf.Graph().as_default():
        ...
        logits = model_2.inference(images, n=4, reuse=tf.AUTO_REUSE,is_training=True)
        val_logits = model_2.inference(images, n=4, reuse=tf.AUTO_REUSE,is_training=False)
