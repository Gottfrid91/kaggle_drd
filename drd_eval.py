...
parser.add_argument('--eval_dir', type=str,
                    default='/home/olle/PycharmProjects/kaggle_drd/tf_offic_weights/',
...
def evaluate():
    ...
    with tf.Graph().as_default() as g:
        ...
        prediction= tf.cast(tf.argmax(soft_max_logits, axis=1), tf.int32)
        ...
        while True:
            eval_once(saver, summary_writer, top_k_op, summary_op, logits, images, labels, prediction, acc)
            if FLAGS.run_once:
                break
